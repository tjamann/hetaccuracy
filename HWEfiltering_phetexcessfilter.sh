...
#clean up old files
rm PHETE-FILTERED*
rm mpileup.filteredindiv.recode.vcf.gz
rm GATK.filteredindiv.recode.vcf.gz
rm hetaccuracies.csv
rm hetaccuraciesaverages.csv
...
python filterphetexcess.py -vcf_list allsamplesafterfiltering.mpileup.vcf -pval_file mpileup.hwe --pval 0.2
python filterphetexcess.py -vcf_list final.GATK.break.vcf.recode.vcf -pval_file GATK.hwe --pval 0.2

#recompress
#does python script generate new file names?

bgzip PHETE-FILTERED_allsamplesafterfiltering.mpileup.vcf
bgzip PHETE-FILTERED_final.GATK.break.vcf.recode.vcf
tabix -p vcf PHETE-FILTERED_allsamplesafterfiltering.mpileup.vcf.gz
...
vcftools --gzvcf PHETE-FILTERED_allsamplesafterfiltering.mpileup.vcf.gz --keep $KEEP --remove-filtered-all --recode --out mpileup.filteredindiv
